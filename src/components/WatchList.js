...
//           {stock.isDown ? (<KeyboardArrowDown className="down"/>):(<KeyboardArrowUp className="" />)}
...
//           <button className="buy text-center">Buy</button>
//         </Tooltip>

//         <Tooltip title="Sell (S)" placement="top" arrow TransitionComponent={Grow}>
//           <button className="sell text-center">Sell</button>
//         </Tooltip>

//         <Tooltip title="Analytic (A)" placement="top" arrow TransitionComponent={Grow}>
//           <button className="action text-center">
